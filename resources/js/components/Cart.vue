                  ...
                  >
                    ...
                    >
                      <li
                        ...
                        v-for="(item, idx) in $parent.editQty != null
                          ? $parent.editQty
                          : $parent.cart.item"
                        :key="idx"
                      >
                            ...
                            <div class="cart-qty">
                              ...
                              <div class="info-qty" v-if="$parent.hideCheckOut">
                                ...
                                <a
                                  class="qty-up"
                                  href="javascript:;"
                                  @click="$parent.editQtyCart(item, 1)"
                        ...
                        <div class="wrap-cart-remove">
                          <a
                            href="javascript:;"
                            @click="$parent.removeCart(item.id)"
                    ...
                    <div class="link-cart" :style="{'text-align':'center','display':$parent.isScreenPc()?'flex':'block'}">
                      ...
                      <a
                        href="javascript:;"
                        class="cart-checkout"
                        @click="$parent.saveCart()"
                        v-if="$parent.hideCheckOut"
                        >Save</a
                      >
                      <a
                        href="#"
